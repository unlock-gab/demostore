# Demo Store | متجر هواتف وإكسسوارات - الجزائر

## نظرة عامة
منصة ديمو لعرض متاجر التجارة الإلكترونية للهواتف والإكسسوارات.
نيش: هواتف ذكية، صوتيات، حافظات، شاحنات، إكسسوارات.
مبني بـ React + Express.js مع قاعدة بيانات PostgreSQL عبر Drizzle ORM.
العملة: دج (الدينار الجزائري). البلد المستهدف: الجزائر.
اللون الرئيسي: أزرق (217 91% 55%).
